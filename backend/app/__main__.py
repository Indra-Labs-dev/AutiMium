...
from app.routes import network, malware, bruteforce, reports, tools, websocket_routes, monitoring, auth, kali_router
...
app.include_router(kali_router.router, prefix="/kali", tags=["Kali Linux Tools"])
